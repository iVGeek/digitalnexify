...
class pesapalV30Helper {
   ...
   * Demo API = use our demo endpoint https://cybqa.pesapal.com/pesapalv3
   */
  ...
  public function getRegisteredIpn($access_token){
    ...
    * $access_token  = Token you received from calling getAccessToken()
   */
  public function getNotificationId($access_token, $ipn_url){
    $headers = array();
    $headers['accept'] = 'text/plain';
    $headers['content-type'] = 'application/json';
    $headers['authorization'] = 'Bearer '.$access_token;
  ...
  public function getMerchertOrderURL($request, $access_token){
    ...
    $postData["app_id"] = 'cdda7f09-5dfe-4c7a-b98c-ddbed669e45a';
